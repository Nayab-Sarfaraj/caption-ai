...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-[var(--stage)] font-[family-name:var(--font-geist-sans)] text-[var(--ink)]">
      <header className="max-w-3xl mx-auto px-4 sm:px-8 h-16 flex items-center">
        <Link href="/" className="flex items-center gap-2">
          <span className="text-[15px] font-extrabold tracking-[-0.02em]"><span className="text-[var(--brand)]">Insta</span>cap</span>
        </Link>
      </header>

      <main className="max-w-3xl mx-auto px-4 sm:px-8 py-10 sm:py-14">
        <p className="text-[11px] tracking-[0.15em] uppercase text-[var(--mute)] mb-1.5">{'// Legal'}</p>
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight font-[family-name:var(--font-display)] mb-2">Terms of Service</h1>
        <p className="text-xs text-[var(--mute)] mb-10">Last updated: July 17, 2026</p>

        <div className="space-y-8 text-sm leading-relaxed text-[var(--ink-dim)]">
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">2. What Instacap Does</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">3. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">4. Your Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">5. Plans, Billing &amp; Cancellation</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">6. Upload Limits &amp; Fair Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">7. Data Retention</h2>
            <p>
              ...
              <Link href="/privacy" className="text-[var(--brand)] hover:underline">Privacy Policy</Link> for details.
            </p>
          </section>

          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">8. Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">9. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">10. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">11. Contact</h2>
            <p>
          ...
          <p className="text-xs text-[var(--mute)] pt-4 border-t border-[var(--hair)]">

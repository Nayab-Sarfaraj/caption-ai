  ...
  return (
    <div className="min-h-screen bg-[var(--stage)] font-[family-name:var(--font-geist-sans)] text-[var(--ink)]">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-8 py-10 sm:py-14">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight font-[family-name:var(--font-display)] mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-[var(--ink-dim)]">
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">1. What We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">2. How We Use It</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">3. Third-Party Processors</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">4. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">5. Cookies &amp; Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">6. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">7. Children&rsquo;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[var(--ink)] mb-2">9. Contact</h2>
            <p>
          ...
          <p className="text-xs text-[var(--mute)] pt-4 border-t border-[var(--hair)]">
            ...
            our <Link href="/terms" className="text-[var(--brand)] hover:underline">Terms of Service</Link>.
          </p>
        </div>
      </main>
    </div>

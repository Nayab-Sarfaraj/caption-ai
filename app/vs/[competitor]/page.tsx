...
const COMPARISON_MAP: Record<string, CompetitorMeta> = {
  veed: {
    ...
    metaDescription:
      'Looking for a VEED.io alternative with no credit meters or per-render limits? Instacap offers 21+ animated caption styles for a flat price.',
    ...
    ourAdvantages: [
      ...
      '21+ real animated caption styles (Hormozi, Hype, Neon, etc.)',
  ...
  'captions-ai': {
    ...
    metaDescription:
      'Compare Instacap and Captions.ai. Get 21+ real customizable caption styles, direct SRT/VTT import, and unlimited exports with no credits.',
  ...
  submagic: {
    ...
    ourAdvantages: [
      ...
      '21+ high-retention caption styles built-in',
    ],
    faqs: [
      {
